...
If we modeled $`\boldsymbol{\Sigma}^{(k)}`$ as a *full* matrix, we would
...
#> 5  Class 1         1   Q3       no  0.24363075
#> 6  Class 1         1   Q3      yes -0.24363075
...
#> 13 Class 1         1   Q7       no -0.30480805
#> 14 Class 1         1   Q7      yes  0.30480805
#> 15 Class 1         1   Q8       no -0.22556037
#> 16 Class 1         1   Q8      yes  0.22556037
```
...
observations to stabilize the eigenvectors. As a rough rule:
...
loadings. SLD keeps the original $`K`$-class latent variable and applies
a closed-form eigendecomposition of the class-conditional residual Burt
matrix to obtain a rank-$`d_k`$ shift to the log response surface.
...
#>  [4] ggplot2_4.0.3       recipes_1.3.2       lattice_0.22-9     
#>  [7] vctrs_0.7.3         tools_4.6.0         generics_0.1.4     
#> [10] parallel_4.6.0      tidyclust_0.3.0     tibble_3.3.1       
...
#> [22] textshaping_1.0.5   codetools_0.2-20    DiceDesign_1.10    
#> [25] htmltools_0.5.9     class_7.3-23        sass_0.4.10        
#> [28] yaml_2.3.12         tune_2.1.0          prodlim_2026.03.11 
#> [31] furrr_0.4.0         modelenv_0.2.0      pillar_1.11.1      
#> [34] pkgdown_2.2.0       jquerylib_0.1.4     tidyr_1.3.2        
#> [37] MASS_7.3-65         cachem_1.1.0        gower_1.0.2        
#> [40] yardstick_1.4.0     rpart_4.1.27        mclust_6.1.2       
#> [43] parallelly_1.47.0   lava_1.9.1          dials_1.4.3        
#> [46] tidyselect_1.2.1    digest_0.6.39       listenv_0.10.1     
#> [49] dplyr_1.2.1         purrr_1.2.2         splines_4.6.0      
#> [52] fastmap_1.2.0       parsnip_1.6.0       grid_4.6.0         
#> [55] cli_3.6.6           magrittr_2.0.5      survival_3.8-6     
#> [58] future.apply_1.20.2 withr_3.0.2         scales_1.4.0       
#> [61] timechange_0.4.0    lubridate_1.9.5     rmarkdown_2.31     
#> [64] globals_0.19.1      nnet_7.3-20         timeDate_4052.112  
#> [67] ragg_1.5.2          workflows_1.3.0     evaluate_1.0.5     
#> [70] knitr_1.51          hardhat_1.4.3       rsample_1.3.2      
#> [73] rlang_1.2.0         Rcpp_1.1.1-1.1      glue_1.8.1         
#> [76] ipred_0.9-15        jsonlite_2.0.0      R6_2.6.1           
